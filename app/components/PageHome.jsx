            ...
            <div>
                <div id='splash' className='D(tb) W(100%) BdB Bdc(#0280ae.3) Bgc($brandColor)'>
                    <div className='D(tbc) Ta(c) Va(m)'>
                        ...
                        <p className="Tt(u) C(#fff) M(0) Fz(12px) Py(5px) BdT Bdc(#fff.2) Lts(2px) Fw(400)"><b className="Fw(400)">TL;DR:</b> the style sheet of this web site is less than 5KB (Gzipped).</p>
                    </div>
                </div>
